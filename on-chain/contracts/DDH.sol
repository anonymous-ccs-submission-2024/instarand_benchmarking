...
library DDH {
    ...
    function verify_ddh_vrf(
        ...
        // validate proof.gamma is the output of Goldberg VRF w.r.t. stored server pk and inp
        _verifyVRFProof(
            pk,
            proof.gamma,
            proof.c,
        ...
        // ensure the random bitstring y was generated by hashing gamma
        require(y == keccak256(abi.encodePacked(proof.gamma)));
    }
    // FLAG_CHANGE: added 3 benchmark
